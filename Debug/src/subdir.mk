...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -D__NEWLIB__ -DDEBUG -D__CODE_RED -DCORE_M3 -D__USE_CMSIS=CMSIS_CORE_LPC13Uxx -DCPP_USE_HEAP -D__LPC13UXX__ -I"C:\Users\Stcupp\Documents\LPCXpresso_7.5.0_254\LEDCUBE2\LEDCUBE\inc" -I"C:\Users\Stcupp\Documents\LPCXpresso_7.5.0_254\LEDCUBE2\CMSIS_CORE_LPC13Uxx\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
